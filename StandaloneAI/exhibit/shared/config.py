...
class Config:
    ...
    def __init__(self):
        # Depth camera is now used by enabling in Unity
        #self.USE_DEPTH_CAMERA = False

        # If true, then will accept input from Unity as paddles and pong positions
        # If False, then will receive a 2d array of 0s and 1s representing the Unity gamestate
        self.UNITY_RECV_POSITIONS = True
